                    ...
                    <div className="flex flex-wrap justify-between m-4">
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Hitesh Panchal</h2>
                        ...
                        {/* <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="text-gray-500">Resource Provider</p>
                            </div>
                        </div> */}
                        ...
                        <div className="lg:w-1/3 lg:mb-0 p-4">
                            <div className="h-full text-center">
                                ...
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Hritik Kumar</h2>
